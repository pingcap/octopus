...
tdef tdefs[] =
{
	{"../data/part.tbl", "part table", 200000,
		pr_part, sd_part, PSUPP, 0},
	{"../data/partsupp.tbl", "partsupplier table", 200000,
		pr_psupp, sd_psupp, NONE, 0},
	{"../data/supplier.tbl", "suppliers table", 10000,
		pr_supp, sd_supp, NONE, 0},
	{"../data/customer.tbl", "customers table", 150000,
		pr_cust, sd_cust, NONE, 0},
	{"../data/orders.tbl", "order table", 150000,
		pr_order, sd_order, LINE, 0},
	{"../data/lineitem.tbl", "lineitem table", 150000,
		pr_line, sd_line, NONE, 0},
	{"../data/orders.tbl", "orders/lineitem tables", 150000,
		pr_order_line, sd_order, LINE, 0},
	{"../data/part.tbl", "part/partsupplier tables", 200000,
		pr_part_psupp, sd_part, PSUPP, 0},
	{"../data/nation.tbl", "nation table", NATIONS_MAX,
		pr_nation, NO_LFUNC, NONE, 0},
	{"../data/region.tbl", "region table", NATIONS_MAX,
